...
bool yolov8_msgs__msg__bounding_box2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yolov8_msgs.msg._bounding_box2_d.BoundingBox2D", full_classname_dest, 46) == 0);
  }
  yolov8_msgs__msg__BoundingBox2D * ros_message = _ros_message;
  {  // center
    PyObject * field = PyObject_GetAttrString(_pymsg, "center");
    if (!field) {
      return false;
    }
    if (!yolov8_msgs__msg__pose2_d__convert_from_py(field, &ros_message->center)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // size
    ...
    if (!yolov8_msgs__msg__vector2__convert_from_py(field, &ros_message->size)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * yolov8_msgs__msg__bounding_box2_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yolov8_msgs.msg._bounding_box2_d");
  ...
  {  // center
    PyObject * field = NULL;
    field = yolov8_msgs__msg__pose2_d__convert_to_py(&ros_message->center);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // size
    PyObject * field = NULL;
    field = yolov8_msgs__msg__vector2__convert_to_py(&ros_message->size);
    if (!field) {
      return NULL;
    }
    {
