...
static const _BoundingBox3D_type_support_symbol_names_t _BoundingBox3D_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolov8_msgs, msg, BoundingBox3D)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yolov8_msgs, msg, BoundingBox3D)),
  }
};
...
{
  return &::yolov8_msgs::msg::rosidl_typesupport_cpp::BoundingBox3D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, yolov8_msgs, msg, BoundingBox3D)() {
  return get_message_type_support_handle<yolov8_msgs::msg::BoundingBox3D>();
}
