...
#ifndef TF2_WEB_REPUBLISHER__SRV__DETAIL__REPUBLISH_T_FS__FUNCTIONS_H_
#define TF2_WEB_REPUBLISHER__SRV__DETAIL__REPUBLISH_T_FS__FUNCTIONS_H_
...
/// Initialize srv/RepublishTFs message.
/**
...
/// Finalize srv/RepublishTFs message.
/**
...
/// Create srv/RepublishTFs message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tf2_web_republisher__srv__RepublishTFs_Request__init().
...
/// Destroy srv/RepublishTFs message.
/**
 * It calls
 * tf2_web_republisher__srv__RepublishTFs_Request__fini()
...
/// Check for srv/RepublishTFs message equality.
/**
...
/// Copy a srv/RepublishTFs message.
/**
...
/// Initialize array of srv/RepublishTFs messages.
/**
...
/// Finalize array of srv/RepublishTFs messages.
/**
 * It calls
 * tf2_web_republisher__srv__RepublishTFs_Request__fini()
...
/// Create array of srv/RepublishTFs messages.
/**
 * It allocates the memory for the array and calls
 * tf2_web_republisher__srv__RepublishTFs_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RepublishTFs messages.
/**
 * It calls
 * tf2_web_republisher__srv__RepublishTFs_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RepublishTFs message array equality.
/**
...
/// Copy an array of srv/RepublishTFs messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tf2_web_republisher__srv__RepublishTFs_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tf2_web_republisher
...
/**
 * It calls
 * tf2_web_republisher__srv__RepublishTFs_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tf2_web_republisher
...
/**
 * It allocates the memory for the array and calls
 * tf2_web_republisher__srv__RepublishTFs_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tf2_web_republisher
...
/**
 * It calls
 * tf2_web_republisher__srv__RepublishTFs_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TF2_WEB_REPUBLISHER__SRV__DETAIL__REPUBLISH_T_FS__FUNCTIONS_H_
