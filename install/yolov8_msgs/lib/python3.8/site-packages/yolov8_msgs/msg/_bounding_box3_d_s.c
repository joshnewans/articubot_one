...
bool yolov8_msgs__msg__bounding_box3_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yolov8_msgs.msg._bounding_box3_d.BoundingBox3D", full_classname_dest, 46) == 0);
  }
  yolov8_msgs__msg__BoundingBox3D * ros_message = _ros_message;
  {  // center
...
PyObject * yolov8_msgs__msg__bounding_box3_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yolov8_msgs.msg._bounding_box3_d");
