...
bool yolov8_msgs__msg__key_point3_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yolov8_msgs.msg._key_point3_d.KeyPoint3D", full_classname_dest, 40) == 0);
  }
  yolov8_msgs__msg__KeyPoint3D * ros_message = _ros_message;
  {  // id
...
PyObject * yolov8_msgs__msg__key_point3_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yolov8_msgs.msg._key_point3_d");
